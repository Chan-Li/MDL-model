...
TRAIN_IMAGES = 'dataset/mnist/train-images.idx3-ubyte'  #训练集图像的文件名
TRAIN_LABELS ='dataset/mnist/train-labels.idx1-ubyte'  #训练集label的文件名
TEST_IMAGES = 'dataset/mnist/t10k-images.idx3-ubyte'    #测试集图像的文件名
TEST_LABELS = 'dataset/mnist/t10k-labels.idx1-ubyte'    #测试集label的文件名
